...
- Cuando te pregunten por un producto en una sucursal puntual (ej. "cuánto pidió PT de sopaipillas"), usá porLocalIdentificado de buscar_producto_venta — es un dato real, lo que esa sucursal pidió. Aclará igual que sinIdentificar (normalmente la mayor parte del total) queda afuera porque esos pedidos no tienen la sucursal cargada en ConectOca, no porque no hayan pasado — nunca dejes entender que porLocalIdentificado es el 100% de lo que pidió esa sucursal.
